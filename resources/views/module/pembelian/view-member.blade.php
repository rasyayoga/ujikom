                                    ...
                                    <div class="table table-bordered">
                                        <table>
                                            ...
                                            <tr class="service">
                                                ...
                                                <td class="tableitem">
                                                    <p class="itemtext">Rp. 1.000.000</p>
                                                </td>
                                            </tr>
                                            <tr class="tabletitle">
                                                <td></td>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" required value="John Doe" maxlength="50">
                                        </div>
                                        <div class="form-group">
                                            <label for="poin" class="form-label">Poin</label>
                                            <input type="text" name="point" id="poin" value="100" disabled class="form-control">
                                        </div>
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" value="Ya" id="check2" disabled name="check_poin">
